package com.leodias.workshopmongo.config;
...
import com.leodias.workshopmongo.domain.Post;
import com.leodias.workshopmongo.domain.User;
import com.leodias.workshopmongo.dto.AuthorDTO;
import com.leodias.workshopmongo.dto.CommentDTO;
import com.leodias.workshopmongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", sdf.parse("22/03/18"), new AuthorDTO(alex));
